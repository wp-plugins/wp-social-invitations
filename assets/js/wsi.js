...
(function($){ 
	$(function(){
		...
		$(".service-filters a").click(function(){
			...
			window.open(
				WsiMyAjax.admin_url+"?action=wsi_authenticate&redirect_to="+encodeURIComponent(popupurl)+"&provider="+provider+ "&widget_id="+widget_id+"&wsi_locker="+wsi_locker+"&_ts=" + (new Date()).getTime(),
