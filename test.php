<?php
/*!
* Thanks to WordPress Social Login for this code!!
*
...
<head>
	...
	<title>WordPress Social Invitations Requirements Test</title>
	<style>
...
<body>
	<h1 style="text-align:center;">WordPress Social Invitations Requirements Test</h1>

	<p>
		<b>Important</b>: 
	</p>	
	<ul style="margin-left:40px;margin-top:0px;">
		<li>Please include your <b>Website Information</b> when posting support requests.</li>
		<li>Thanks to <a href="http://hybridauth.sourceforge.net/wsl/" target="_blank"><b>WSL</b></a>for this page..</li> 
	</ul>
	<p>
		<b>WordPress Social Invitations requirements are</b>: 
	</p>
	<ul style="margin-left:40px;margin-top:0px;">
		<li>PHP >= 5.3.0 installed</li>
		<li>WSI Endpoint URLs reachable</li>
...
<?php   
	...
	?>
		&nbsp;<i style="color:blue">Testing...</i> (If this "testing" seems to take forever to load, use this <a href="?url=http://www.example.com">direct link</a>.)
		
		<script>
			jQuery(document).ready(function($) {
				$("#urlrewrite").load( "?xhrurl=http://www.example.com" );
			});
		</script>
	<?php
	}
...
<?php 
	if ( version_compare( PHP_VERSION, '5.3.0', '>=' ) ){
		echo "<b style='color:green;'>OK!</b><br />PHP >= 5.3.0 installed.";
	}
	else{ 
		echo "<b style='color:red;'>FAIL!</b><br />PHP >= 5.3.0 not installed.";
	}
?>
	</p>
...
<?php
	if ( isset( $_SESSION["wsi::plugin"] ) ){
		...
		<div style="background-color: #FFFFE0;border:1px solid #E6DB55; border-radius: 3px;padding:5px;font-size: 12px;">  
			...
			<br /><br />
			This problem has also been encountered with WP Engine as they don't allow sessions for non logged users. You will need to talk with them and disable cache.
...
<?php 
	...
	<p>
	<?php require_once('includes/class-wsi-googl.php');
		$goo = new Wsi_Googl;
		$short_url = $goo->shorten('http://wp.timersys.com');
		if( $short_url ){
